...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/views/video/popup.css">
...
<body>
        ...
        <div class="side-inner">
            ...
            <div class="nav-menu">
                <ul>
                    ...
                    <li><a href="${url}/sigDetail"><span class="icon-sign-out mr-3"></span>Sign out</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="containerMenu play-container">
        <div class="row">
            <div class="play-video">
                <iframe width="820" height="515" src="https://www.youtube.com/embed/${urlDetail}?autoplay=1&mute=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <h3>${titleDetail}</h3>
                <div class="play-video-info">
                    <p>1225 Views &bull; 2 days ago</p>
                    <div class="iconChoose">
                        <button name="btnLike" value="${fav}" class="button-31"><a style="color:white" href="${url}/like?url=${urlDetail}&btnName=${fav}">${fav}</a></button>
                        <button class="button-31" id="myBtn">Share</button>
                    </div>
                </div>
                <hr>
            </div>
            ...
            <div class="right-sidebar">
				...
				<div class="side-video-list">
                    <a href="${url}/video-detail?url=${list.id}&title=${list.title}" class="small-thumbnail"> <img width="280px" height="150px" src="https://img.youtube.com/vi/${list.poster}/maxresdefault.jpg"></a>
                    <div class="vid-info">
                        <a href="${url}/video-detail?url=${list.id}&title=${list.title}">${list.title}</a>
                        <p>Easy tutorial</p>
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4>Share to everyone</h4>
				<span class="close">&times;</span>
			</div>
			<form action="${url}/share" method="get">
				<div class="modal-body">
					<label>Link video: </label>
					<br>
					<input name="body" value="https://www.youtube.com/watch?v=${urlDetail}">
					<br>
					<label>Send to: </label>
					<br>
					<input name="to" placeholder="Email your friends?">
				</div>
