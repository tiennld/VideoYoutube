...
<body>
    ...
    <div class="containerMenu">
        <div class="banner">
            <img width="100%" height="400px" src="https://i.pinimg.com/originals/2c/84/5a/2c845a66b8ad2a8aafd288bdc16cd459.jpg">
        </div>
        <div class="list-container">
            ...
            <c:forEach var="list" items="${items}">
				<div class="vid-list">
					<div class="flex-div">
						<a
							href="${url}/video-detail?url=${list.id}&title=${list.title}">
							<img width="320px" height="180px"
							src="https://img.youtube.com/vi/${list.poster}/maxresdefault.jpg">
						</a>
						<div class="video-info">
							<a
								href="${url}/video-detail?url=${list.id}&title=${list.title}">${list.title}</a>
							<p>Easy tutorial</p>
    ...
    <div class="form-btn-load">
	   <form class="form-detail" action="${url}/page" method="get">
